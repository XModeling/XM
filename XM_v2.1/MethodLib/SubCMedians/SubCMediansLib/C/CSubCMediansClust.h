...
public :
    ...
    TBoolean GenerateChangesTracker(CChangesTracker* changesTracker, int verbose);
    void ResetNbObjectsInClusters(CArraySubCMediansPoint* model,CArraySubCMediansPoint* data);
    void UpdateGUsingD(int verbose);
    void TrainOnInstanceImpl(CSubCMediansPoint* SubCMediansPointTraining, int verbose);
    void ComputeFeatures();
    void InsertPointToD(CSubCMediansPoint *SubCMediansPointTraining, int verbose);
    void CloneOtherSubCMediansClust(CSubCMediansClust *other);
    void CloneFeatures(TFeatures *other);
    TAtomicElement GenerateInsertionFromData(CArraySubCMediansPoint *data, CArraySubCMediansPoint *model, TOption option, int verbose);
    TElement ChooseModelPair(TOption option);
    TPointId GenerateCorePointInsertionID(CArraySubCMediansPoint *model, TOption option, int verbose);
